...
fn main() -> Result<(), failure::Error> {
    ...
    loop {
        terminal.draw(|mut f| {
            // TODO: center CardsWidget within the list of PlaceWidget
            ...
            f.render(&mut other_player_cards, Rect::new(21 - (ox / 2), 0, ox, oy));
            ...
            f.render(&mut our_cards, Rect::new(21 - (ox / 2), 14, ox, oy));
        });
